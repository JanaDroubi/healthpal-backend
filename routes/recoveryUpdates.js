...
router.post('/', requireAuth, authorizeRoles('PATIENT', 'DOCTOR', 'ADMIN'), addRecoveryUpdate);

//  Get all updates for a specific case
router.get('/:case_id', requireAuth, authorizeRoles('ADMIN', 'DOCTOR', 'PATIENT', 'DONOR'), getRecoveryUpdatesByCase);
